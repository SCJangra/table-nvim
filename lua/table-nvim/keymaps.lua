...
local set_keymaps = function(buf)
  ...
  map({ 'n', 'i' }, maps.insert_row_up, edit.insert_row_up, opts)
  map({ 'n', 'i' }, maps.insert_row_down, edit.insert_row_down, opts)
  map({ 'n', 'i' }, maps.move_row_up, edit.move_row_up, opts)
  map({ 'n', 'i' }, maps.move_row_down, edit.move_row_down, opts)
  map({ 'n', 'i' }, maps.insert_column_left, edit.insert_column_left, opts)
  map({ 'n', 'i' }, maps.insert_column_right, edit.insert_column_right, opts)
  map({ 'n', 'i' }, maps.move_column_left, edit.move_column_left, opts)
  map({ 'n', 'i' }, maps.move_column_right, edit.move_column_right, opts)
